...
One can either use =EasyPG= or =OpenSSL= as external implementations.
#+begin_src emacs-lisp :tangle no
(mml-smime-use 'epg)
#+end_src
...
(use-package smime
  ...
  ;; (smime-keys '(("ferdinand.pieper@ims.uni-hannover.de" "~/certs/ferdinand.pieper.dfn.20200429.pem" nil)))
  )
#+end_src
*** MUA/Notmuch
